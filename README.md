...
Production-каркас сайта-каталога магазина бытовой техники в Комрате. Репозиторий сейчас завершает только **Этап 1: архитектура и базовый каркас**.
...
- Header, Footer, контейнер, навигация, рабочий телефон и переключатель языка.
- Честные route shells каталога, категории, товара, поиска, контактов и `/admin`.
