...
function mockTransport(): CatalogTransport {
  return {
    ...
    getPopularProductIds: vi.fn().mockResolvedValue(["product"]),
    recordProductView: vi.fn().mockResolvedValue(undefined),
    cleanupOldProductViews: vi.fn().mockResolvedValue(0),
